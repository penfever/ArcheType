...
# export SOTAB_PATH="."
python src/run.py --model_name="flan-t5-xxl-zs-chorusprompt" --save_path="$SAVE_PATH" --input_files="$SOTAB_PATH/Test" --input_labels="$SOTAB_PATH/CTA_test_gt.csv" --label_set="SOTAB-27" --method similarity simple_random_sampling --results --response && \
