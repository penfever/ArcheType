...
new_JSON_OUT_PATH="${JSON_OUT_PATH%/*}/${new_filename}"

export FT_DATA_PATH="$new_JSON_OUT_PATH"

suffix2="-ft-results"
ft_filename="${filename}${suffix}"

# Replace the original filename with the new filename in the path
new_FT_OUT_PATH="${JSON_OUT_PATH%/*}/${ft_filename}"

export FT_RESULTS_PATH="$new_FT_OUT_PATH"
